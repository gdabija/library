...
def registerBook():
    ...
    if (add_book( bookId, bookTitle, bookAuthor, bookStatus )):
        headingLabel = Label( topForMessage, text="Book Added", bg='white', fg='black', font=('New Roman', 13) )
        headingLabel.place( relx=0, rely=0, relwidth=1, relheight=1 )

    else:
        headingLabel = Label( topForMessage, text="Could not add Book", bg='white', fg='black', font=('New Roman', 13) )
        headingLabel.place( relx=0, rely=0, relwidth=1, relheight=1 )
