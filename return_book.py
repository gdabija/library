...
def returnBook():
    ...
    headingLabel = Label( headingFrame, text="Return Book", bg='saddlebrown', fg='white', font=('New Roman', 13) )
    ...
    button = Button( top, text="SUBMIT", bg="black", fg="black", command=returnFollowingBook )
...
def returnFollowingBook():
    ...
    if (return_book(bookId)):
        headingLabel = Label( topForMessage, text="Book Returned", bg='white', fg='black', font=('New Roman', 13) )
        headingLabel.place( relx=0, rely=0, relwidth=1, relheight=1 )

    else:
        headingLabel = Label( topForMessage, text="Could not return Book", bg='white', fg='black', font=('New Roman', 13) )
        headingLabel.place( relx=0, rely=0, relwidth=1, relheight=1 )
    top.destroy()
